...
def candidate(live=False):
 p=pkg();return {'schema_version':'C6_FORMAL_AUTHORIZATION_V1','stage':'C6_FORMAL','execution_authorized':live,'formal_allowed':live,'contract_sha':p['contract_sha'],'plan_sha':p['plan_sha'],'authorities':p['authorities'],'platform_qualification_authority':PLATFORM,'metrics':p['metrics'],'cells':p['cells'],'retry_policy':p['retry_policy'],'storage_policy':p['storage_policy'],'tracking_outcome_read_allowed':False,'science_adaptation_allowed':False}
