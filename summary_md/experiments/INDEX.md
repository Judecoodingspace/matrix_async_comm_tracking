...
| `exp_20260817_001_mdmt_mia_candidate_compensation_onset_validation` | 2026-08-17 | 非测试数据上的候选集合补偿起点验证 | MDMT train/val proposed cohorts | 冻结 E023 R4-R6；ID delay d1-d5；development 选择 onset；train/val holdout 确认；official test 禁止调参 | `outputs/20260817_mdmt_mia_candidate_compensation_onset_validation/` | proposed, research-blocked | Contract、ExecPlan、RunPlan、AnalysisPlan 与流程图已建立；尚无实现或结果。 | 等待 R1 非测试 MDA 协议、R2 cohort policy、R3 delay/onset rule 明确批准。Contract: `summary_md/experiments/2026-8-17/exp_20260817_001_mdmt_mia_candidate_compensation_onset_validation/EXPERIMENT_CONTRACT.md` |
